...
namespace AzWebApp1.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public IActionResult Post([FromBody] string body)
        {
            ...
            var name = JObject.Parse(body)["name"];

            //return name;
            //return (ActionResult)new OkObjectResult(new string[] { "value1", "value2" });
            return name != null
                ? (ActionResult)new OkObjectResult(new string[] { "value1", "value2" })
                : new BadRequestObjectResult("A name value was not provided in body of request.");
        }
